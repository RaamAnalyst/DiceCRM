    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.leads.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lead_title') ? 'is-invalid' : '' }}" type="text" name="lead_title" id="lead_title" value="{{ old('lead_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('lead_description') ? 'is-invalid' : '' }}" name="lead_description" id="lead_description">{!! old('lead_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Lead::QUALIFIED_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('qualified') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="qualified_{{ $key }}" name="qualified" value="{{ $key }}" {{ old('qualified', '') === (string) $key ? 'checked' : '' }} required>
