    ...
    <div class="card">
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class=" table table-bordered table-striped table-hover datatable datatable-relatedCommentsComments">
                    <thead>
                        <tr>
                            <th width="10">
                            ...
                            <th>
                                {{ trans('cruds.comment.fields.attachments') }}
                            </th>
                            <th>
                                &nbsp;
                            </th>
                    ...
                    <tbody>
                        @foreach($comments as $key => $comment)
                            <tr data-entry-id="{{ $comment->id }}">
                                ...
                                <td>
                                    @foreach($comment->attachments as $key => $media)
...
@endcan
  ...
  let table = $('.datatable-relatedCommentsComments:not(.ajaxTable)').DataTable({ buttons: dtButtons })
