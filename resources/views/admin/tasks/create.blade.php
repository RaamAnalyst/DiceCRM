    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tasks.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('task_title') ? 'is-invalid' : '' }}" type="text" name="task_title" id="task_title" value="{{ old('task_title', '') }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('task_description') ? 'is-invalid' : '' }}" name="task_description" id="task_description">{!! old('task_description') !!}</textarea>
